...
public class SystemInfo
{
	...
	private int _getCpuCount(){ return 1; }
	private void _updateCpu(int index, CPU cpu, boolean all){};
	private void _updateMemory(Memory memory, Memory swap){};
	private void _update(SystemInfo sysinfo, OS os){};
	private void _updateAvg(CPU avg){};
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		System.out.println("CPU Model: " + sysinfo.cpu().model());
