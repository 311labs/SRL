...
// INTERNAL NATIVE CALLBACKS
	static protected native boolean _update();
	static protected native boolean _update_iface(NetworkInterface iface);
	...
	{
		List<NetworkInterface> all = getAll();
		for (int i=0; i<20;++i)
		{
			System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
			for (NetworkInterface iface : all)
			{
